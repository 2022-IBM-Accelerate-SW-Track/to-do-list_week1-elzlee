      ...
      return (
        ...
        <div>
          <TextField //text field input
            label="Add New Item"
            variant="outlined"
            onChange={this.handleChange} //onChange is an event. Use handleChange function when user types anything
            value={this.state.content}
          />
          <Button
            style={{ marginLeft: "10px" }}
            onClick={this.handleSubmit} //use handleSubmit function when user Clicks
            variant="contained"
            color="primary"
          >
            Add
